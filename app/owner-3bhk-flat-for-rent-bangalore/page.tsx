...
import G4BHKCarousal from "../components/G4BHKCarousal";
        ...
        <main className={layout.page}>
            <div className="mx-auto max-w-3xl">
                ...
                <h1 className="text-3xl font-bold text-gray-900 mb-4">
                    Owner Listed 3BHK Flat for Rent in Bangalore
                </h1>
    ...
    <div className="mt-6 space-y-4">
        ...
        <div className="p-6 bg-gray-50 rounded-xl border border-gray-200">
            ...
            <div className="relative" style={{ paddingBottom: "56.25%", height: 0 }}>
                <iframe
                    ...
                    src="https://www.youtube.com/embed/2_g1K6f8QEc"
                    title="3BHK Apartment Ulsoor Video"
        ...
        <div className="p-6 bg-gray-50 rounded-xl border border-gray-200">
            ...
            <div className="relative" style={{ paddingBottom: "56.25%", height: 0 }}>
                <iframe
                    className="absolute top-0 left-0 w-full h-full rounded-lg"
                    src="https://www.youtube.com/embed/kQF2Rmmw55w"
                    title="3BHK Apartment Ulsoor Balcony Video"
                    frameBorder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
                />
