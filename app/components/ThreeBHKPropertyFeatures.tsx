...
const features = [
  { name: '3 Bedrooms', icon: HomeIcon, bg: 'bg-indigo-50', text: 'text-indigo-600' },
  ...
  { name: 'East Facing', icon: ArrowUpIcon, bg: 'bg-amber-50', text: 'text-amber-600' },
  ...
  { name: 'Two Balconies & Utility Area', icon: RectangleStackIcon, bg: 'bg-sky-50', text: 'text-sky-600' },
